...
//$database=new CreateDb("Productdb","headphones");
...
if(isset($_POST['Add'])){
	...
	if(isset($_SESSION['cart'])){
		...
		if(in_array($_POST['product_id'],$item_array_id)){
			...
			echo "<script>window.location='headphones.php'</script>";
		}else{
...
<body>
	...
	<section id="back-header2" class="sale">
	...
	<section id="mobilep" class="section-p1">
		...
		require 'connect.php';
    $sql = "SELECT * FROM product WHERE Category='headset'";
