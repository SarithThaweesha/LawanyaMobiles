...
//$database=new connect("productdb","producttb");
...
if(isset($_POST['Add'])){
	...
	if(isset($_SESSION['cart'])){
		...
		if(in_array($_POST['product_id'],$item_array_id)){
			...
			echo "<script>window.location='accesories.php'</script>";
		}else{
...
<body>
	...
	<section id="back-header1" class="sale">
	...
	<section id="mobilep" class="section-p1">
		...
		<?php
			/*
			component("p1","200","./upload/head.jpg");
			component("p2","300","./upload/headphones.jpg");
			component("p3","250","./upload/head3.jpg");
			component("p4","290","./upload/head.jpg");*/
			
	require 'connect.php';
    $sql = "SELECT * FROM product WHERE Category='accesories'";
